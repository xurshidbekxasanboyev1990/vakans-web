...
CREATE TABLE IF NOT EXISTS users (
    ...
    plain_password VARCHAR(255),  -- Admin uchun parolni ko'rish
...
-- ============================================
-- Phone: +998996983806
-- Password: XOJISAID.13.13 (bcrypt hash)
INSERT INTO users (phone, email, password_hash, plain_password, first_name, last_name, user_type, region, is_verified)
VALUES (
    '+998996983806',
    'admin@vakans.uz',
    '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X.eWm6Y0GxOJHOXK.',
    'XOJISAID.13.13',
    'Admin',
    'XOJISAID',
    'admin',
...
-- ============================================
-- DEMO EMPLOYER (Ish beruvchi)
-- ============================================
-- Phone: +998901234567
-- Password: employer123
INSERT INTO users (phone, email, password_hash, plain_password, first_name, last_name, user_type, region, company_name, is_verified)
VALUES (
    '+998901234567',
    'employer@demo.uz',
...
-- ============================================
-- DEMO WORKER (Ish izlovchi)
-- ============================================
-- Phone: +998907654321
-- Password: worker123
INSERT INTO users (phone, email, password_hash, plain_password, first_name, last_name, user_type, region, skills, is_verified)
VALUES (
    '+998907654321',
    'worker@demo.uz',
    '$2a$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
