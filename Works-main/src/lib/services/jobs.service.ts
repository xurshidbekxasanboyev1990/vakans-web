...
export class JobsService {
  ...
  async createJob(jobData: CreateJobRequest): Promise<SingleJobResponse> {
    try {
      ...
      logError('Create job error', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      };
  ...
  async updateJob(jobData: UpdateJobRequest): Promise<SingleJobResponse> {
    try {
      ...
      logError('Update job error', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      };
  ...
  async deleteJob(jobId: string): Promise<{ success: boolean; error?: string }> {
    try {
      ...
      logError('Delete job error', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      };
  ...
  async getMyJobs(): Promise<JobsResponse> {
    try {
      ...
      logError('Get my jobs error', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      };
  ...
  async applyToJob(
    ...
    try {
      ...
      logError('Apply to job error', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      };
