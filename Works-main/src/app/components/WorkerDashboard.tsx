...
export function WorkerDashboard({
  ...
  return (
    <div className="min-h-screen bg-[#dae1e7] dark:bg-gray-950">
      ...
      {/* Search & Filters */}
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-3 sm:space-y-4">
        {/* Stats Bar */}
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
          <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-gray-900 rounded-lg sm:rounded-xl shadow-md">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-xl shadow-blue-500/5 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-2 mb-2 sm:mb-3">
            <Filter className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-500" />
            <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">{t('searchAndFilters')}</span>
          </div>
      ...
      {/* Jobs Grid */}
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-6 sm:pb-8" ref={jobsListRef}>
        <div className="mb-4 sm:mb-6 flex items-center justify-between">
          ...
          <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs sm:text-sm font-medium">
            {filteredJobs.length} {t('count')}
          </span>
        </div>
        
        {filteredJobs.length === 0 ? (
          <div className="flex items-center justify-center min-h-[300px] sm:min-h-[400px] bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
            <div className="text-center space-y-3 sm:space-y-4 p-6 sm:p-8">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 flex items-center justify-center">
