      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-4 sm:space-y-6">
        ...
        {!showForm && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
            <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-md border border-gray-300 dark:border-gray-700">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center flex-shrink-0">
                  <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <div className="min-w-0">
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{activeJobs}</p>
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">{t('activeAds')}</p>
                </div>
              </div>
            </div>
            ...
            <div 
              ...
              className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-md border border-gray-300 dark:border-gray-700 cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-200"
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center flex-shrink-0">
                  <Users className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <div className="min-w-0">
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{totalApplications}</p>
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">{t('totalApplications')} →</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">{t('newApplications')} →</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-md border border-gray-300 dark:border-gray-700">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{completedJobs}</p>
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">{t('completed')}</p>
                </div>
              </div>
            </div>
          </div>
