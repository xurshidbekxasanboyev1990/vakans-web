...
export function UsersManagement({ users, onBlockUser, onUpdateUser, onResetPassword, onSendMessage, onChangeRole, onDeleteUser }: UsersManagementProps) {
  ...
  // Parolni ko'rish - SECURITY: Plain passwords are never stored or exposed
  ...
  // Parolni nusxalash - disabled for security
  const handleCopyPassword = () => {
    // SECURITY: Plain passwords should never be accessible
    console.warn('Plain password access is disabled for security reasons');
  };
              ...
              <div className="space-y-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    🔒 Xavfsizlik: Parollar hashlangan va ko'rinmaydi
                  </p>
                </div>
